...
namespace System.Drawing.Html
{
    ...
    public class CssBox
    {
        ...
        public void Paint(Graphics g)
        {
            ...
            if (Display == CssConstants.TableCell && EmptyCells == CssConstants.Hide && IsSpaceOrEmpty)
            {
                return;
            }

            List<RectangleF> areas = Rectangles.Count == 0 ?new List<RectangleF>(new RectangleF[] { Bounds }) : new List<RectangleF>(Rectangles.Values);
